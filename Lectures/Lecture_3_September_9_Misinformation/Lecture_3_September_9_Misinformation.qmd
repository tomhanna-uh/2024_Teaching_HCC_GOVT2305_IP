...
- Today 
        ...
        - Announcements
        - Written Exercise 3: Start
        - Misinformation and Extra Credit Quiz Answers
        - Written Exercise 4: Finish

- Wednesday

        - Return written exercises 2 an 3
        - Early American Governing Documents: Right and Wrong

## Announcements

- Grades are entered for the two writing exercises
- Out of class work: Do the *Modules* in Canvas, in order
- Do not do any assignments outside the **Modules** in Canvas 
- Don't backdoor into the assignments from the Gradebook, etc.
- There are unused, ungraded assignments not in the Modules that you will end up doing for no reason if you get out of the Modules. 

# Written Exercise 3

## Written Exercise 3: Priorities

::: {.custom-style style="font-size: 40px;"}
Considering only federal spending, not state projects, what do you think is the most important federal priority?
:::

::: {.custom-style style="font-size: 40px;"}
What do you think is a reasonable amount per person for the fedeeral government to spend on this?
:::

::: {.custom-style style="font-size: 40px;"}
How much do you think the federal government actually spends per person on this?
:::

## Written Exercise 3

::: {.custom-style style="font-size: 40px;"}
How much do you think the federal government spends per person on each of these items: defense, education, health care for non-seniors, healthcare for seniors, social spending outside Social Security and Disability Insurance, Social Security and disability for non-veterans?
:::
...
Based on this, do you think the **federal government** spending on your priority is about right, too little or too much. If it's too little, what would you cut? should reallocate spending? IWhy?
:::

::: {.custom-style style="font-size: 20px;"}
(Bear in mind, the issue here is federal spending in the context of current federal share of spending. We will address the proper state and federal share when we discuss federalism. For example, most education spending is currently state and local. Changing that allocation is a separate issue.)
:::
...
## Written Exercise 3: Actual Spending per Person

- Social Security and Disability Insurance: $3,630
- Social spending outside Social Security and Disability Insurance: $4,653
- Health care for non-seniors: $2,229
- Health care for seniors (Medicare): $2,163
- Defense: $2,145
- Education (Education, Training, Employment, and Social Services): $729 

::: {.custom-style style="font-size: 20px;"}
This is spending per person regardless of age. So this is education spending per person including people who aren't in school, not per student. It is Social Security spending per person including people who aren't retired, not per retiree.
:::

## Written Exercise 3

::: {.custom-style style="font-size: 40px;"}
Based on this, do you think the federal government should reallocate spending? If so, how?
:::
